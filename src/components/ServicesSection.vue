<template>
    <section class="text-white mt-20" id="services">
        ...
        <div class="py-8 xl:px-16 sm:py-16 grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-12 lg:grid-cols-3">
            ...
            >
            <div class="mx-auto h-24 w-24 text-center cl:h-28 xl:w-28">
                <div>
...
const services =ref([
    {
        ...
        description:'lorem, ipsum dolosa ajdjan asiyhcbas usbsjbcsuw  usugcb, ushg!'
    },
    {
        id:2,
        icon:'https://img.icons8.com/ios-filled/100/ffffff/google-code.png',
