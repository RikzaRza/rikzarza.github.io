...
const testimonials = ref([
    {
        ...
        comment:'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores mollitia vel sed ipsam modi reiciendis, fugit sint nesciunt corporis esse illo, consectetur dolorum sunt quo delectus amet. Voluptate, ab cupiditate?'
    },
    {
        id:2,
        fullname:'client 2',
